...
<div id="content">
  ...
  <div class="card-body">
                    <form action="<?php echo site_url('Keeper/Keepereditdaykeywat1'); ?>" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input  type="date" name="dkw_date" id="datetimepicker"
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="form-control" type="text" name="dkw_detail"><?php echo $edit->dkw_detail;?></textarea>
                                </div>
                            </div>
                        </div>
